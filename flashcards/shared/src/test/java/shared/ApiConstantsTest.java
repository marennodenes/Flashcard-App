...
public class ApiConstantsTest {
     ...
     */
    @Test
    void testUserOperationConstants() {
        ...
        assertEquals("Could not complete user operation\nPlease try again", ApiConstants.USER_OPERATION_FAILED);
    }
     ...
     */
    @Test
    void testLoginOperationConstants() {
        ...
        assertEquals("Login failed\nPlease check your credentials and try again", ApiConstants.LOGIN_OPERATION_FAILED);
     ...
     */
    @Test
    void testPasswordValidationConstants() {
        // Password validation success messages
        assertEquals("Password validation successful", ApiConstants.PASSWORD_VALIDATION_SUCCESSFUL);
        ...
        assertEquals("Error validating password", ApiConstants.PASSWORD_VALIDATION_ERROR);
    }
     ...
     */
    @Test
    void testFlashcardOperationConstants() {
        ...
        assertEquals("Could not complete flashcard operation - Please try again", ApiConstants.FLASHCARD_OPERATION_FAILED);
    }
     ...
     */
    @Test
    void testDeckOperationConstants() {
        ...
        assertEquals("Could not complete deck operation - Please try again", ApiConstants.DECK_OPERATION_FAILED);
        assertEquals("Could not update deck - Please try again", ApiConstants.DECK_UPDATE_FAILED);
    }
    /**
    ...
    void testGeneralConstants() {
        ...
        assertEquals("An unexpected error occurred - Please try again", ApiConstants.UNEXPECTED_ERROR);
        ...
        assertEquals("Could not connect to server - Please check that the server is running", ApiConstants.SERVER_CONNECTION_ERROR);
        assertEquals("No valid button to get stage for scene switch", ApiConstants.NO_VALID_BUTTON_FOR_SCENE_SWITCH);
    }
     ...
     */
    @Test
    void testUIValidationConstants() {
        ...
        assertEquals("Flashcard question and answer cannot be empty", ApiConstants.FLASHCARD_QUESTION_ANSWER_EMPTY);
    }
     ...
     */
    @Test
    void testGeneralSystemConstants() {
