...
public class ApiConstants {
  ...
  public static final String USER_OPERATION_FAILED = 
      "Could not complete user operation\nPlease try again";
  ...
  public static final String LOGIN_OPERATION_FAILED = 
  ...
  public static final String PASSWORD_MISSING_UPPERCASE = 
      "Password must contain at\nleast one uppercase letter";
  public static final String PASSWORD_MISSING_LOWERCASE = 
      "Password must contain at\nleast one lowercase letter";
  public static final String PASSWORD_MISSING_DIGIT = 
      "Password must contain\nat least one digit";
  public static final String PASSWORD_MISSING_SPECIAL = 
  ...
  public static final String FLASHCARD_OPERATION_FAILED = 
      "Could not complete flashcard operation - Please try again";
  ...
  public static final String DECK_OPERATION_FAILED = 
      "Could not complete deck operation - Please try again";
  ...
  public static final String SERVER_CONNECTION_ERROR = 
      "Could not connect to server - Please check that the server is running";
  public static final String NO_VALID_BUTTON_FOR_SCENE_SWITCH = 
      "No valid button to get stage for scene switch";
}