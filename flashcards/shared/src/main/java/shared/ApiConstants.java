...
public class ApiConstants {
  ...
  public static final String FAILED_TO_CREATE_FLASHCARD = "Failed to create flashcard";
  public static final String FAILED_TO_DELETE_FLASHCARD = "Failed to delete flashcard";
