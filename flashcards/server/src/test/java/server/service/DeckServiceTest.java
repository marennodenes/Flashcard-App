 ...
 * 
 * <p>This test class verifies the functionality of deck management operations including
 ...
 * 
 * <p>All deck operations require a valid username and depend on user existence
...
public class DeckServiceTest {
   ...
   * 
   * <p>This method creates a new DeckService instance with the mocked
   ...
   * 
   * <p>This test verifies that the DeckService constructor properly validates
   ...
   * 
   * <p>The method should validate user existence before attempting to retrieve
  ...
  public void testGetAllDecks() throws IOException {
    ...
    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, 
        () -> deckService.getAllDecks(username2));
  ...
  public void testGetDeck() {
    ...
    try {
      ...
      IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, 
          () -> deckService.getDeck(username, nonExistingDeckName));
  ...
  */
  ...
  public void testDeleteDeck() {
    ...
    try {
      ...
      IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, 
          () -> deckService.deleteDeck(username2, deckname2));
   ...
   * 
   * <p>This test verifies that all deck operations properly validate user
   ...
   */
  @Test
  public void testUpdateAllDecks() throws IOException {
    String username = "existingUser";
    FlashcardDeckManager manager = new FlashcardDeckManager();
    ...
    deckService.updateAllDecks(username, manager);
    org.mockito.Mockito.verify(flashcardPersistent).writeDeck(eq(username),
        any(FlashcardDeckManager.class));
  }
}
